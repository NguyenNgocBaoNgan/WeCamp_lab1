...
public class UsersTest extends TestBase {
    //homework: file user test
    //get users: trả về status code là 500
...
//  as well as JUnit assertions and very nice AssertJ assertions with extracting fields from objects
    ...
    @Test
    public void shouldReturnStatusCode500_whenGetUsers(){
        REQUEST.get("/users").then().assertThat().statusCode(500);
    }
    @Test
    //get 1 user có id bằng 123 trả về status code 404 not found
    public void shouldReturnStatusCode404_whenGetUser(){
